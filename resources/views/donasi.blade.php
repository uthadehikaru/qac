...
<section id="faq" class="bg-white pt-24 text-gray-700">
    <div class="container px-5 mx-auto">
        ...
        <a href="https://wa.me/{{ \App\Models\System::value('whatsapp_ecourse') }}?text=Assalaamu'alaikum QAC, saya ingin donasi. terima kasih" target="_blank" class="flex justify-center"><img src="{{ asset('images/waadmin.png') }}" alt="WA Admin QAC" class="w-1/2 md:w-1/3"></a>
