    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center mt-24 px-4 md:px-0">
            ...
            <div class="border-4 border-black rounded-lg">
                <video class="" controls controlsList="nodownload">
                    <source src="{{ asset('storage/videos/qac-2.mp4') }}" type="video/mp4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-start mt-24 px-4 md:px-0">
            <div class="flex flex-col items-center justify-center px-4 md:px-0">
                ...
                <img src="{{ asset('images/qac 2/tujuan.png') }}" alt="Tujuan QAC 2.0" class="w-full md:w-3/4 mx-auto h-auto">
            </div>
            <div class="flex flex-col justify-center px-4 md:px-0 gap-4 md:gap-8">
                <h2 class="text-2xl font-bold text-center mb-4 md:mb-12">Apa aja yang akan dibahas?</h2>
                <div class="flex items-center justify-center">
                    <img src="{{ asset('images/qac 2/1.png') }}" alt="Tujuan 1 QAC 2.0" class="h-24 md:h-32 mx-0 md:mx-24">
                    <p class="text-right text-xl font-montserrat px-0 md:px-12">Fokus <span class="font-bold">1 kata dan perubahannya</span> (sharf dasar) tentang Keluarga Kecil</p>
                </div>
                <div class="flex items-center justify-center">
                    <p class="text-left text-xl font-montserrat px-0 md:px-12"><span class="font-bold">Pendalaman makna</span>, mengupas Keluarga Besar</p>
                    <img src="{{ asset('images/qac 2/2.png') }}" alt="Tujuan 2 QAC 2.0" class="h-24 md:h-32 mx-0 md:mx-24">
                </div>
                <div class="flex items-center justify-center">
                    <img src="{{ asset('images/qac 2/3.png') }}" alt="Tujuan 3 QAC 2.0" class="h-24 md:h-32 mx-0 md:mx-24">
                    <p class="text-right text-xl font-montserrat px-0 md:px-12">Contoh-contoh <span class="font-bold">Tadabbur Al-Qur’an versi QAC 2.0</span></p>
                </div>
            </div>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-start mt-24 mx-2 py-0 md:py-8">
            <div class="rounded-lg bg-[#ffdf79] p-4">
                <h2 class="text-2xl md:text-xl text-center mb-4 underline">Fasilitas apa yang didapatkan?</h2>
            ...
            <div class="p-4">
                <h2 class="text-2xl md:text-xl text-center mb-4 underline">Teknis (perlu komitmen)</h2>
                <ul class="flex flex-col gap-4">
                    <li class="flex justify-start items-center gap-2">
