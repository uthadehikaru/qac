            ...
            <div class="rounded-lg bg-[#ffdf79] p-4">
                ...
                <ul class="flex flex-col gap-4">
                    <li class="flex justify-start items-center gap-2">
                        ...
                        <p class="text-base font-montserrat">Kursus 1 sesi persiapan + <span class="font-bold">15 x sesi</span></p>
                    </li>
                    <li class="flex justify-start items-center gap-2">
            ...
            <div class="p-4">
                ...
                <ul class="flex flex-col gap-4">
                    <li class="flex justify-start items-center gap-2">
                        ...
                        <p class="text-base font-montserrat">Setiap hari <span class="font-bold">berturut-turut</span> @1 jam : <br>
