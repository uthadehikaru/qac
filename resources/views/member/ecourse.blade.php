<x-app-layout>
    <x-slot name="header">
        <a href="{{ route('member.ecourses.index') }}" class=" text-red-800 font-semibold text-xl text-gray-800 leading-tight inline">
            My Courses
        </a>
            ...
            <div class="w-full flex flex-col md:flex-row p-6">
                ...
                <div class="w-full md:w-1/3 flex flex-col mt-4">
                    ...
                    <div class="mt-12">
                        ...
                        <a href="https://wa.me/{{ \App\Models\System::value('whatsapp') }}?text={{ urlencode('Halo QAC, saya ingin bertanya sesuatu.') }}" class="mt-3 text-green-500 hover:text-red-800" target="_blank">
