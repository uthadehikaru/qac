...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-theme="light">
    ...
    <body class="font-sans antialiased" style="font-family: 'Comfortaa', sans-serif;">
        <div class="min-h-screen bg-gray-100">
            ...
            <header class="bg-white shadow">
                <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-2">
                    {{ $header }}
                </div>
            </header>
            @endif
            ...
            <footer class="text-gray-600 body-font fixed bottom-0 w-full">
                <div class="bg-gray-100">
                    ...
                    <span class="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                        ...
                        <a class="text-gray-500 pointer text-sm ml-2" href="{{ route('admin.clear-cache') }}" target="_blank">Clear Cache</a>
                    </span>
                    @endif
                    </div>
                </div>
