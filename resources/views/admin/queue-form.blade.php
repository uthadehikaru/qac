<x-app-layout>
    <x-slot name="header">
        ...
        Tambah Waiting List
        - <a href="{{ route('admin.courses.queues.index', [$course->id]) }}" class="pointer text-blue-500">@lang('Course') {{ $course->name }}</a>
        </h2>
    ...
    <x-panel>
        ...
        action="{{ route('admin.courses.queues.store', [$course->id]) }}"
