        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <div class="flex">
                        <span class="title-font font-medium text-2xl text-gray-900 {{ $ecourse->price_sell>0?'line-through':'' }}">
                            Rp. {{ $ecourse->price }}
                        </span>
                        @if($ecourse->price_sell>0)
                        <span class="ml-2 title-font font-medium text-4xl text-red-500">
                            Rp. {{ $ecourse->price_sell }}
                        </span>
                        @endif
                        <button class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Daftar</button>
