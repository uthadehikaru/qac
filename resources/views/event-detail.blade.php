<x-web-layout>
    ...
    <section class="mt-20 bg-white text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
            ...
            <img alt="{{ $event->title }}" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="{{ $event->imageUrl('thumbnail') }}">
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div class="flex mb-4">
                    ...
                    <span class="flex ml-3 pl-3 py-2 border-l-2 border-gray-200 space-x-2s">
                        bagikan :
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('event.detail',$event->slug)) }}&quote={{ urlencode('Yuk ikutan event QAC bersama saya') }}" class="text-gray-500" target="_blank">
                        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                            <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                        </svg>
                        </a>
                        <a href="https://twitter.com/intent/tweet?url={{ urlencode(route('event.detail',$event->slug)) }}&text={{ urlencode('Yuk ikutan event QAC bersama saya') }}" class="ml-2 text-gray-500" target="_blank">
                        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                            <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
                        </svg>
                        </a>
                        <a href="https://wa.me/?text={{ urlencode('Yuk ikutan event QAC Bersama saya. '.route('event.detail',$event->slug)) }}" class="ml-2 text-gray-500" target="_blank">
                        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                ...
                <p class="leading-relaxed">{!! nl2br($event->content) !!}</p>
            </div>
            </div>
        </div>
    </section>
