            ...
            <div class="flex flex-wrap">
                <div class="w-full sm:w-1/4 p-6">
                    <video width="400" height="800" controls controlsList="nodownload">
                        <source src="{{ asset('media/why1.2.mp4') }}?v=20240205" type="video/mp4">
                    </video>
                </div>
                <div class="w-full sm:w-1/4 p-6">
                    <video width="400" height="800" controls controlsList="nodownload">
                        <source src="{{ asset('media/why2.2.mp4') }}?v=20240205" type="video/mp4">
                    </video>
                </div>
                <div class="w-full sm:w-1/4 p-6">
                    <video width="400" height="800" controls controlsList="nodownload">
                        <source src="{{ asset('media/why3.2.mp4') }}?v=20240205" type="video/mp4">
                    </video>
                </div>
                <div class="w-full sm:w-1/4 p-6">
                    <video width="400" height="800" controls controlsList="nodownload">
                        <source src="{{ asset('media/why4.2.mp4') }}?v=20240205" type="video/mp4">
                    </video>
                </div>
            </div>
        </div>
